...
class TestFileLoaders(unittest.TestCase):
    ...
    def test_pdf_loader(self):
        ...
        """
        self.file_path = "/home/shtlp_0046/Desktop/Assignment4/files/sample.pdf"
    ...
    def test_docx_loader(self):
        ...
        """
        self.file_path = "/home/shtlp_0046/Desktop/Assignment4/files/Sample_file2.docx"
    ...
    def test_ppt_loader(self):
        ...
        """
        self.file_path = "/home/shtlp_0046/Desktop/Assignment4/files/Sample_file3.pptx"
    ...
    def test_pdf_loader_invalid_file(self):
        ...
        """
        self.file_path = "/home/shtlp_0046/Desktop/Assignment4/files/non_existent_file.pdf"
        loader = PDFLoader(self.file_path)
    ...
    def test_docx_loader_invalid_file(self):
        ...
        """
        self.file_path = "/home/shtlp_0046/Desktop/Assignment4/files/non_existent_file.docx"
        loader = DOCXLoader(self.file_path)
        self.assertFalse(loader.validate_file())
    ...
    def test_ppt_loader_invalid_file(self):
        ...
        """
        self.file_path = "/home/shtlp_0046/Desktop/Assignment4/files/non_existent_file.pptx"
        loader = PPTLoader(self.file_path)
        self.assertFalse(loader.validate_file())
